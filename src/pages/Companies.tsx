...
export default function Companies() {
  ...
  const columns: { key: keyof Company; label: string; sortable?: boolean }[] = [
    { key: "company_name", label: "Company Name", sortable: true },
    { key: "company_code", label: "Code", sortable: true },
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            onClick={() => {
              setEditCompany(null); // new company
              setModalOpen(true);
            }}
      ...
      {/* Management Modal (reused from existing components) */}
      {modalOpen && (
        <ManagementModal
          isOpen={modalOpen}
          onClose={() => {
            setModalOpen(false);
            setEditCompany(null);
            fetchCompanies(); // refresh after changes
          }}
