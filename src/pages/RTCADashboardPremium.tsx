...
import RTCABusinessGrowthChart from "../components/rtca/RTCABusinessGrowthChart";
...
export default function RTCADashboardPremium() {
  ...
  return <main className="min-h-screen bg-[#f4f7fa] text-slate-900 dark:bg-slate-950 dark:text-white">
    <div className="mx-auto max-w-[1680px] px-4 py-5 sm:px-6 lg:px-8">
      ...
      <section className="mt-5"><Panel title="Business Growth Trend" subtitle="Track Requirement and Filled Headcount Growth Over Time"><RTCABusinessGrowthChart rows={rows} loading={loading} error={error} /></Panel></section>
